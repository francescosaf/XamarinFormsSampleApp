...
namespace SampleApp
{
	public class DetailStepPageOLD : ContentPage
	{
		public static ListView listView;
		StackLayout layout;
		private static List<StepCellAnimateHeightOLD> m_entries = new List<StepCellAnimateHeightOLD> ();
		//public static Image iconmap;
		public DetailStepPageOLD ()
		{
			...
			DataTemplate listTemplate = new DataTemplate(typeof(StepCellAnimateHeightOLD));
		...
		public static void CellViewAccordionControl(StepCellAnimateHeightOLD cellViewTapped){
